...
class MkAnalyticsClassVisitor extends ClassVisitor implements Opcodes {
    ...
    private final static String SDK_API_CLASS = "com/cxz/auto_track_sdk/SensorsDataAutoTrackHelper"
    ...
    MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        methodVisitor = buildMethodVisitorV2(methodVisitor, access, name, desc)
        return methodVisitor
    }

    MethodVisitor buildMethodVisitorV2(MethodVisitor methodVisitor, int access, String name, String desc) {
        String nameDesc = name + desc
        methodVisitor = new MkAnalyticsDefaultMethodVisitorV2(methodVisitor, access, name, desc) {
            ...
            AnnotationVisitor visitAnnotation(String s, boolean b) {
                if (s == 'Lcom/cxz/auto_track_sdk/SensorsDataTrackViewOnClick;') {
    ...
    MethodVisitor buildMethodVisitor(MethodVisitor methodVisitor, int access, String name, String desc) {
        String nameDesc = name + desc
